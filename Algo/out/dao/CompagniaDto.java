 ...
 */
@Dto
public class CompagniaDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_compagnia", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_compagnia", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_compagnia", nullable = false)
	@Expose
	private String des;
