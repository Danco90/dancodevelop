 ...
 */
@Dto
public class CompletezzaDatiDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_completezza_dati", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_completezza_dati", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_completezza_dati", nullable = false)
	@Expose
	private String des;
