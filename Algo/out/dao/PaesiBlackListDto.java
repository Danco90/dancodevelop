 ...
 */
@Dto
public class PaesiBlackListDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_paesi_black_list", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_paesi_black_list", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_paesi_black_list", nullable = false)
	@Expose
	private String des;
