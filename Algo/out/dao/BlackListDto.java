 ...
 */
@Dto
public class BlackListDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_black_list", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_black_list", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_black_list", nullable = false)
	@Expose
	private String des;
