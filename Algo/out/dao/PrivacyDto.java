 ...
 */
@Dto
public class PrivacyDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_privacy", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_privacy", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_privacy", nullable = false)
	@Expose
	private String des;
