 ...
 */
@Dto
public class StatoCivileDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_stato_civile", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_stato_civile", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_stato_civile", nullable = false)
	@Expose
	private String des;
