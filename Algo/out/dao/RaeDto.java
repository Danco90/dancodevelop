 ...
 */
@Dto
public class RaeDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_rae", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_rae", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_rae", nullable = false)
	@Expose
	private String des;
