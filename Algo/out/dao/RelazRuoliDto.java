 ...
 */
@Dto
public class RelazRuoliDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_relaz_ruoli", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_relaz_ruoli", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_relaz_ruoli", nullable = false)
	@Expose
	private String des;
