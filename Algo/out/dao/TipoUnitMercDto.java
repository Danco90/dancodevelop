 ...
 */
@Dto
public class TipoUnitMercDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_unit_merc", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_unit_merc", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_unit_merc", nullable = false)
	@Expose
	private String des;
