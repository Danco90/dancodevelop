 ...
 */
@Dto
public class FamigliaNodoDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_famiglia_nodo", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_famiglia_nodo", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_famiglia_nodo", nullable = false)
	@Expose
	private String des;
