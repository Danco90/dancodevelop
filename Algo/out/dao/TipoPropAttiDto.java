 ...
 */
@Dto
public class TipoPropAttiDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_prop_atti", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_prop_atti", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_prop_atti", nullable = false)
	@Expose
	private String des;
