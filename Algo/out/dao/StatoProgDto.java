 ...
 */
@Dto
public class StatoProgDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_stato_prog", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_stato_prog", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_stato_prog", nullable = false)
	@Expose
	private String des;
