 ...
 */
@Dto
public class TipoPremioDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_premio", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_premio", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_premio", nullable = false)
	@Expose
	private String des;
