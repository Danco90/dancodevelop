 ...
 */
@Dto
public class CausaleEstinzioneDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_causale_estinzione", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_causale_estinzione", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_causale_estinzione", nullable = false)
	@Expose
	private String des;
