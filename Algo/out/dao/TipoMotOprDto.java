 ...
 */
@Dto
public class TipoMotOprDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_mot_opr", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_mot_opr", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_mot_opr", nullable = false)
	@Expose
	private String des;
