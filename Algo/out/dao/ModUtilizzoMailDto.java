 ...
 */
@Dto
public class ModUtilizzoMailDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_mod_utilizzo_mail", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_mod_utilizzo_mail", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_mod_utilizzo_mail", nullable = false)
	@Expose
	private String des;
