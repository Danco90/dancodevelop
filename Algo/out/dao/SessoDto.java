 ...
 */
@Dto
public class SessoDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_sesso", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_sesso", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_sesso", nullable = false)
	@Expose
	private String des;
