 ...
 */
@Dto
public class TipoSpecieGiuridicaDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_specie_giuridica", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_specie_giuridica", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_specie_giuridica", nullable = false)
	@Expose
	private String des;
