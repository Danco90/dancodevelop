 ...
 */
@Dto
public class PortafogliDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_portafogli", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_portafogli", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_portafogli", nullable = false)
	@Expose
	private String des;
