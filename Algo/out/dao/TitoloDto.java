 ...
 */
@Dto
public class TitoloDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_titolo", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_titolo", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_titolo", nullable = false)
	@Expose
	private String des;
