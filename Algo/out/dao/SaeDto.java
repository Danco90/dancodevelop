 ...
 */
@Dto
public class SaeDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_sae", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_sae", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_sae", nullable = false)
	@Expose
	private String des;
