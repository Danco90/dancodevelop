 ...
 */
@Dto
public class TipoLineaVenditaDto implements java.io.Serializable, BaseDto {
	
	private static final long serialVersionUID = 1L;
	
	@Key
	@DataType(name = "k_tipo_linea_vendita", nullable = false)
	@Expose
	private int id;
	
	
	@DataType(name = "cod_tipo_linea_vendita", nullable = false)
	@Expose
	private String cod;
	
	@DataType(name = "des_tipo_linea_vendita", nullable = false)
	@Expose
	private String des;
